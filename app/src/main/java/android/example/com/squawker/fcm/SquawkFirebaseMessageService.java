...
public class SquawkFirebaseMessageService extends FirebaseMessagingService {
    ...
    private final String LOG_TAG = SquawkFirebaseMessageService.class.getSimpleName();
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        //Check if data contains pay load
        Map<String, String> data = remoteMessage.getData();

        if(data.size() > 0){
            Log.d(LOG_TAG, "Message data payload: "+data);

            //Send notification tha you got a new notification
    ...
    private void insertSquawk(final Map<String, String> data){
        //Database operation should not be done on the mainThread
